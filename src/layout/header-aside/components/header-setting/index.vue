<template>
  <div class="ibps-header-setting">
    ...
    <el-drawer class="ibps-header-setting-drawer" :visible.sync="settingVisible" :title="$t('navbar.setting')" width="30%">
      <el-scrollbar style="height: 100%;width:100%;" wrap-class="ibps-header-setting-wrapper ibps-scrollbar-wrapper">
          ...
          <div class="panel-body">
            <el-table :data="themeList" :show-header="false" border>
              ...
              <el-table-column width="100">
                <div slot-scope="scope" :style="{'backgroundImage': `url(${$baseUrl}${scope.row.preview})`}" class="theme-preview" />
              </el-table-column>
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <el-color-picker v-model="color" :predefine="predefine" size="mini" @change="handleColorChange" />
          </div>
        </div>
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <el-radio-group v-model="language">
              <el-radio v-for="item in languageList" :key="item.value" :label="item.value">{{ item.label }}</el-radio>
            </el-radio-group>
          </div>
        </div>
        <div class="panel panel-info">
