    ...
    <div class="error-page-container">
      <div class="wscn-http404">
        ...
        <div class="bullshit">
          ...
          <div class="bullshit__info"><a class="link-type" href="http://www.bpmhome.cn" target="_blank" rel="noopener noreferrer">{{ companyName }}</a>©{{ $t('common.copyright') }}</div>
...
export default {
  ...
  data() {
    return {
      ...
      companyName: process.env.VUE_APP_COMPANY
    }
  },
  computed: {
    message() {
