<template>
  ...
  >
    ...
    <el-form-item prop="email">
      <el-input v-model="loginForm.email" :placeholder="$t('system.login.email')" autocomplete="off" prefix-icon="iconfont ibps-icon-envelope" @keyup.enter.native="handleRegister" />
    </el-form-item>
    <el-form-item prop="mobile">
      <el-input v-model="loginForm.mobile" :placeholder="$t('system.login.mobile')" autocomplete="off" prefix-icon="iconfont ibps-icon-mobile" @keyup.enter.native="handleRegister" />
    </el-form-item>
    <el-form-item prop="passWd">
      <el-input v-model="loginForm.passWd" :type="passwordType" :placeholder="$t('system.login.password')" prefix-icon="ibps-icon-lock" autocomplete="off" @keyup.enter.native="handleRegister">
        <i slot="suffix" :class="passwordType=='password'?'ibps-icon-eye-slash':'ibps-icon-eye'" class=" el-input__icon" @click="showPassword" />
      </el-input>
    </el-form-item>
    <el-form-item prop="validCode">
      <el-input v-model="loginForm.validCode" :placeholder="$t('system.login.code')" autocomplete="off" prefix-icon="iconfont ibps-icon-qrcode" @keyup.enter.native="handleRegister">
