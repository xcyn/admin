  ...
  >
    ...
    <el-form-item prop="gender">
      <el-radio-group v-model="loginForm.gender">
        <el-radio label="男">{{ $t('system.login.gender.male') }}</el-radio>
        <el-radio label="女">{{ $t('system.login.gender.female') }}</el-radio>
      </el-radio-group>
    </el-form-item>
    ...
    <el-form-item prop="mobile">
      <el-input v-model="loginForm.mobile" :placeholder="$t('system.login.mobile')" auto-complete="off" prefix-icon="iconfont ibps-icon-mobile" @keyup.enter.native="handleRegister" />
    </el-form-item>
    <el-form-item prop="passWd">
      <el-input v-model="loginForm.passWd" :type="passwordType" :placeholder="$t('system.login.password')" prefix-icon="ibps-icon-lock" auto-complete="off" @keyup.enter.native="handleRegister">
        <i slot="suffix" :class="passwordType=='password'?'ibps-icon-eye-slash':'ibps-icon-eye'" class=" el-input__icon" @click="showPassword" />
      </el-input>
    </el-form-item>
    <el-form-item prop="validCode">
      <el-input v-model="loginForm.validCode" :placeholder="$t('system.login.code')" auto-complete="off" prefix-icon="iconfont ibps-icon-qrcode" @keyup.enter.native="handleRegister">
