<template>
  <el-form ref="loginForm" :rules="loginRules" :model="loginForm" class="login-form" label-width="0">
    <el-form-item prop="mobile">
      <el-input v-model="loginForm.mobile" clearable :placeholder="$t('system.login.mobile')" auto-complete="off" prefix-icon="iconfont ibps-icon-mobile" @keyup.enter.native="handleForget" />
    </el-form-item>
    <el-form-item prop="passWd">
      <el-input v-model="loginForm.passWd" clearable :type="passwordType" :placeholder="$t('system.login.password')" prefix-icon="ibps-icon-lock" auto-complete="off" @keyup.enter.native="handleForget">
        <i slot="suffix" :class="passwordType=='password'?'ibps-icon-eye-slash':'ibps-icon-eye'" class=" el-input__icon" @click="showPassword" />
      </el-input>
    </el-form-item>
    <el-form-item prop="validCode">
      <el-input v-model="loginForm.validCode" clearable :placeholder="$t('system.login.code')" auto-complete="off" prefix-icon="iconfont ibps-icon-qrcode" @keyup.enter.native="handleForget">
    ...
    <el-form-item>
      <el-button type="primary" class="login-submit" @click.native.prevent="handleForget">{{ $t('system.login.resetPassword') }}</el-button>
    </el-form-item>
    <el-form-item>
