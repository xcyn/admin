  ...
  >
    <el-form-item prop="companyName">
      <el-input
        ...
        :placeholder="$t('system.login.company')"
        auto-complete="off"
        clearable
      ...
      <el-col :span="12">
        <el-form-item prop="code">
          <el-input
            ...
            :placeholder="$t('system.login.companyCode')"
            auto-complete="off"
            clearable
    ...
    <el-form-item prop="street">
      <el-input
        ...
        :placeholder="$t('system.login.street')"
        auto-complete="off"
        clearable
        prefix-icon="iconfont ibps-icon-user"
        @keyup.enter.native="handleRegister"
      ...
      <el-col :span="16">
        <el-form-item prop="name">
          <el-input
            ...
            :placeholder="$t('system.login.fullName')"
            auto-complete="off"
            clearable
            prefix-icon="iconfont ibps-icon-user"
            @keyup.enter.native="handleRegister"
      ...
      <el-col :span="8">
        <el-form-item prop="gender">
          <el-radio-group v-model="formData.gender" class="register-radio">
            <el-radio label="male">{{ $t('system.login.gender.male') }}</el-radio>
            <el-radio label="female">{{ $t('system.login.gender.female') }}</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-col>
    </el-row>
    <el-form-item prop="email">
      <el-input v-model="formData.email" clearable :placeholder="$t('system.login.email')" auto-complete="off" prefix-icon="iconfont ibps-icon-envelope" @keyup.enter.native="handleRegister" />
    </el-form-item>
    <el-form-item prop="account">
      <el-input v-model="formData.account" clearable :placeholder="$t('system.login.account')" auto-complete="off" prefix-icon="iconfont ibps-icon-mobile" @keyup.enter.native="handleRegister" />
    </el-form-item>
    <el-form-item prop="password">
      <el-input v-model="formData.password" clearable :type="passwordType" :placeholder="$t('system.login.password')" prefix-icon="ibps-icon-lock" auto-complete="off" @keyup.enter.native="handleRegister">
        <i slot="suffix" :class="passwordType=='password'?'ibps-icon-eye-slash':'ibps-icon-eye'" class=" el-input__icon" @click="showPassword" />
      </el-input>
    </el-form-item>
    <el-form-item prop="phone">
      <el-input v-model="formData.phone" clearable :placeholder="$t('system.login.mobile')" auto-complete="off" prefix-icon="iconfont ibps-icon-mobile" @keyup.enter.native="handleRegister" />
    </el-form-item>
    <el-form-item>
      <el-form-item prop="validCode">
        <el-input v-model="formData.validCode" :placeholder="$t('system.login.code')" auto-complete="off" prefix-icon="iconfont ibps-icon-mobile" @keyup.enter.native="handleRegister">
      ...
      <el-form-item>
        <el-button type="primary" class="login-submit" @click.native.prevent="handleRegister">{{ $t('system.login.registration') }}</el-button>
      </el-form-item>
      <el-form-item>
