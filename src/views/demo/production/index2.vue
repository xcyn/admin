  ...
  <ibps-container type="full" class="page">
    ...
    <div class="dynamic-form">
      ...
      <div class="form-header">
        <div class="title">Pure-测试生成代码-布局-栅格</div>
      </div>
      <el-form
        ref="form"
        :model="models"
...
export default {
  ...
  data() {
    return {
      dynamicForm: this,
      models: { 'id': '', 'createTime': '', 'duoXingWenBen': '', 'jiShuQi': '', 'duoXuanKuang': [], 'riQiKongJian': '', 'huaKuai': 0, 'yinCangYu': '', 'shuJuZiDian': '', 'tuPian': '', 'ziDingYiDuiHuaKuang': '', 'danXingWenBen': '', 'shuZu': '', 'danXuanKuang': '', 'xiaLaKuang': '', 'kaiGuan': 'N', 'pingFen': 0, 'fuWenBen': '', 'shangChuanFuJian': '', 'xuanZeQi': '', 'zbdkjzy': [{ 'id': '', 'parentId': '', 'createBy': '' }] },
      inline: false,
      labelSuffix: '',
      labelWidth: '100px',
      labelPosition: 'right',
