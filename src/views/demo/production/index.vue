  ...
  <ibps-container type="full" class="page">
    ...
    <div class="dynamic-form">
      ...
      <div class="form-header">
        <div class="title">Pure-测试生成代码-整体</div>
      </div>
      <el-form
        ref="form"
        :model="models"
...
export default {
  ...
  data() {
    return {
      dynamicForm: this,
      models: { 'createTime': '', 'id': '', 'danXingWenBen': '', 'duoXingWenBen': '', 'shuZu': '', 'jiShuQi': '', 'danXuanKuang': '', 'duoXuanKuang': [], 'xiaLaKuang': '', 'riQiKongJian': '', 'kaiGuan': 'N', 'huaKuai': 0, 'pingFen': 0, 'yinCangYu': '', 'fuWenBen': '', 'shuJuZiDian': '', 'shangChuanFuJian': '', 'tuPian': '', 'xuanZeQi': '', 'ziDingYiDuiHuaKuang': '', 'zbdkjzy': [{ 'id': '', 'parentId': '', 'createBy': '' }] },
      inline: false,
      labelSuffix: '',
      labelWidth: '100px',
      labelPosition: 'right',
