  ...
  <ibps-container type="full" class="page">
    ...
    <div class="dynamic-form">
      ...
      <div class="form-header">
        <div class="title">Pure-测试生成代码-布局-折叠面板</div>
      </div>
      <el-form
        ref="form"
        :model="models"
      ...
      >
        <el-collapse
          v-model="formLayout.collapse_0ye2ahp"
          type="undefined"
          :accordion="false"
        ...
        >
          ...
          <el-collapse-item name="collapse2">
            <span slot="title">折叠面板2</span>
...
export default {
  ...
  data() {
    return {
      dynamicForm: this,
      models: { 'id': '', 'duoXingWenBen': '', 'jiShuQi': '', 'duoXuanKuang': [], 'riQiKongJian': '', 'huaKuai': 0, 'fuWenBen': '', 'shuJuZiDian': '', 'shangChuanFuJian': '', 'createTime': '', 'danXingWenBen': '', 'danXuanKuang': '', 'xiaLaKuang': '', 'pingFen': 0, 'shuZu': '', 'yinCangYu': '', 'zbdkjzy': [{ 'id': '', 'parentId': '', 'createBy': '' }], 'tuPian': '', 'xuanZeQi': '', 'kaiGuan': 'N', 'ziDingYiDuiHuaKuang': '' },
      inline: false,
      labelSuffix: '',
      labelWidth: '100px',
      labelPosition: 'right',
      ...
      formLayout: { collapse_0ye2ahp: ['collapse1', 'collapse2'] },
