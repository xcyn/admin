...
<script>
import { pending4UserExtend } from '@/api/platform/office/bpmReceived'
...
export default {
    ...
    return {
      ...
      listConfig: {
        ...
        columns: [
          ...
          { prop: 'name', label: '当前节点', width: 250 },
          { prop: 'createTime', label: '创建时间', width: 160 },
          { prop: 'ownerName', label: '所属人', width: 120 }
        ]
      },
      pagination: {},
      sorts: {},
  ...
  methods: {
    ...
    loadData(id) {
      this.loading = true
      pending4UserExtend(this.getFormatParams(id)).then(response => {
