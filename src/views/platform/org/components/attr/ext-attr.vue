    ...
    <el-row>
      <el-col :span="24">
        <div class="ibps-tools-btn">
          <el-button v-permission="identity + '_save'" type="primary" icon="ibps-icon-save" @click="saveData">保存</el-button>
          <el-button v-permission="identity + '_clean'" type="info" icon="ibps-icon-clean" @click="clearData">清空</el-button>
        </div>
      </el-col>
