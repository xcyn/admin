    ...
    <el-row>
      <el-col :span="24">
        <div class="position-btn">
          <el-button v-permission="identity +'_add_position'" type="primary" icon="ibps-icon-add" @click="handleAssign">指定组织</el-button>
          <el-button v-if="hasOrg" v-permission="identity +'_clean_position'" type="primary" icon="ibps-icon-trash-o" @click="handleClear">清除组织</el-button>
        </div>
      </el-col>
