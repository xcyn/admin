  ...
  >
    <div slot="title" class="ibps-pl-5">
      ...
      <template v-if="$utils.isEmpty(id)||status==='draft'">
        <el-button v-permission="BPMN_BPMN_DEF_DESIGN+'_save'" type="primary" icon="ibps-icon-save" class="ibps-ml-5" @click="handleSave(true,false)">发布</el-button>
        <el-button v-permission="BPMN_BPMN_DEF_DESIGN+'_draft'" type="primary" icon="ibps-icon-clipboard" class="ibps-ml-5" @click="handleSave(false,false)">保存草稿</el-button>
      </template>
      <template v-else>
        <el-button v-permission="BPMN_BPMN_DEF_DESIGN+'_save'" type="primary" icon="ibps-icon-save" class="ibps-ml-5" @click="handleSave(true,false)">保存</el-button>
        <el-button v-permission="BPMN_BPMN_DEF_DESIGN+'_new_version'" type="primary" icon="ibps-icon-clipboard" class="ibps-ml-5" @click="handleSave(true,true)">发布新版本</el-button>
      </template>
      <el-upload
        ref="upload"
        :auto-upload="false"
      ...
      >
        <el-button slot="trigger" v-permission="BPMN_BPMN_DEF_DESIGN+'_import_bpmn'" type="primary" icon="ibps-icon-import">导入BPMN</el-button>
      </el-upload>
      <el-button v-permission="BPMN_BPMN_DEF_DESIGN+'_export_bpmn'" type="primary" icon="ibps-icon-export" class="ibps-ml-5" @click="handleExportBPMN()">导出BPMN</el-button>
      <el-button v-permission="BPMN_BPMN_DEF_DESIGN+'_export_svg'" type="primary" icon="ibps-icon-file-code-o" class="ibps-ml-5" @click="handleExportSVG()">导出SVG</el-button>
...
import DiagramJSMinimap from 'diagram-js-minimap'// 小地图
...
import CamundaModdleDescriptor from '@/business/platform/bpmn/bpmn-js/camunda-bpmn-moddle/resources/camunda'
...
export default {
  ...
  data() {
    return {
      BPMN_BPMN_DEF_DESIGN: Identity.IBPS.BPMN.BPMN_BPMN_DEF_DESIGN,
