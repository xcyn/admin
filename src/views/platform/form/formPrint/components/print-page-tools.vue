...
export default {
  ...
  methods: {
    ...
    _setSelect: function(type, action, value) {
      ...
      const f = ['fontSize', 'fontFamily', 'marginTop', 'marginBottom']
