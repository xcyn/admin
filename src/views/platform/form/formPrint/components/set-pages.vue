<template>
  <div class="menu-tools-set-pages">
    ...
    <el-form ref="form" class="items" :model="form" :rules="rules" label-position="top" size="mini">
      ...
      <el-form-item label="纸张方向" prop="layout">
        <el-select v-model="form.layout" placeholder="请选择" size="mini" class="form-item-select">
          <el-option
...
export default {
  ...
  data() {
    ...
    return {
      ...
      layoutOptions: [{ value: 'portrait', label: '纵向' }, { value: 'landscape', label: '横向' }],
      rules: {
        pageWidth: [
