  ...
  >
    ...
    >
      <template slot="header">
        <el-button v-permission="DESKTOP_LAYOUT+'_save'" type="primary" icon="ibps-icon-save" @click="save()">保存</el-button>
        <el-button v-permission="DESKTOP_LAYOUT+'_add_cloumn'" icon="ibps-icon-add" @click="handleAdd()">添加栏目</el-button>
        <el-button v-permission="DESKTOP_LAYOUT+'_undo'" type="info" icon="ibps-icon-undo" @click="handleRestoreDefault()">还原默认</el-button>
        <el-button v-permission="DESKTOP_LAYOUT+'_preview'" type="success" icon="ibps-icon-eye" @click="dialogPreviewVisible =true">预览</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      DESKTOP_LAYOUT: Identity.IBPS.SYSTEM.DESKTOP_LAYOUT,
