<template>
  ...
  >
    <template slot="header">
      <el-button v-permission="MY_LAYOUT_DESIGN+'_save'" type="primary" icon="ibps-icon-save" @click="handleSave()">保存</el-button>
      <el-button v-permission="MY_LAYOUT_DESIGN+'_save_cloumn'" icon="ibps-icon-add" @click="handleAdd()">添加栏目</el-button>
      <el-button v-permission="MY_LAYOUT_DESIGN+'_reset'" type="danger" icon="ibps-icon-undo" @click="handleReset()">重置</el-button>
      <el-button v-permission="MY_LAYOUT_DESIGN+'_undo'" type="info" icon="ibps-icon-undo" @click="handleRestoreDefault()">还原默认</el-button>
    </template>
    <desktop-layout
      :data="layout"
      :ectypal="ectypal"
...
export default {
  ...
  data() {
    return {
      ...
      MY_LAYOUT_DESIGN: Identity.IBPS.DESKTOP.MY_LAYOUT_DESIGN,
      scrollDelay: 0,
      scrollTop: 0,
      loading: false,
      layout: [],
