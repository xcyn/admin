  ...
  <div v-else class="main-container">
    <ibps-container type="full" class="page">
      <template slot="header">
        <el-button v-permission="CAT_TYPE+'_save'" type="primary" :disabled="readonly" icon="ibps-icon-save" @click="handleSave()">保存</el-button>
      </template>
...
export default {
  ...
  data() {
    return {
      ...
      CAT_TYPE: Identity.IBPS.SYSTEM.CAT_TYPE,
      dialogVisible: false,
      dialogLoading: false,
