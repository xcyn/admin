<template>
  ...
  >
    <template slot="header">
      <el-button v-permission="RESOURCES+'_save'" type="primary" icon="ibps-icon-save" @click="handleSave()">保存</el-button>
    ...
    <el-form ref="resourcesForm" :model="resources" :rules="rules" :label-width="formLabelWidth" @submit.native.prevent>
      ...
      <el-form-item v-if="resources.resourceType === 'dir' || resources.resourceType === 'menu' " label="显示到菜单:" prop="displayInMenu">
        <el-switch
    ...
    return {
      ...
      rules: {
        ...
        sn: [{ required: true, message: this.$t('validate.required') },
          { type: 'number', validator: validateInteger }],
