<template>
  <div class="main-container">
    <ibps-crud
      ...
      :loading="loading"
      :identity="identity.CLIENTGRANTDIALOG"
    ...
    >
      ...
      <el-input v-if="dialog&&grantType==='user'" slot="searchFormGrantKey" :value="appKey" disabled clearable />
      <el-input v-else-if="dialog&&grantType==='client'" slot="searchFormGrantKey" :value="clientKey" disabled clearable />
    ...
    <edit
      ...
      :identity="identity.CLIENTGRANTDIALOGAUDIT"
      @callback="search"
...
export default {
  ...
  props: {
    ...
    identity: {
      type: Object,
      default: () => ({
        CLIENTGRANTDIALOG: Identity.IBPS.SYSTEM.APP_GRANT,
        CLIENTGRANTDIALOGAUDIT: Identity.IBPS.SYSTEM.APP_GRANT
      })
    }
  },
  data() {
