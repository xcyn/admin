  ...
  <ibps-container v-loading="loading" type="full" class="ibps-card-list-container">
    ...
    <ibps-layout ref="layout">
      <div>
        <!--添加-->
        <div
          :style="hasPermission({key: 'addForm'})? 'pointer-events : none':''"
          ...
          >
            ...
            <div class="ibps-card-list__item-action" @click.stop="void 0">
              <el-dropdown
                ...
                @command="(action,instance)=> { handleActionEvent(action,'manage',data,index,instance) }"
              >
                ...
                <el-dropdown-menu slot="dropdown">
                  <template v-for="action in rowHandle.actions">
                    <el-dropdown-item
                      :key="action.key"
                      v-permission="getPermissionKey(action)"
                      :command="action"
                      :icon="action.icon"
