...
export default {
  IBPS: {
    ORG: {
      ...
      POSITION_EXTATTR: 'ibps_org_position_ext_attr',
    ...
    SYSTEM: {
      ...
      APP_GRANT_DIALOG: 'ibps_system_app_grant_dialog',
      APP_GRANT_DIALOG_AUDIT: 'ibps_system_app_grant_dialog_audit',
    ...
    FORM: {
      ...
      BODEFDIALOGMOREVERSIONS: 'ibps_form_bodef_dialog_more_versions',
      BODEF_TREE: 'ibps_form_bodef_tree',
      FORM_DEF: 'ibps_form_form_def',
      FORM_DEF_TREE: 'ibps_form_form_def_tree',
      FORM_DETAIL: 'ibps_form_form_detail',
      FORM_COMBINATION: 'ibps_form_form_combination'
    },
    //
    BPMN: {
