<template>
  ...
  >
    ...
    <div>
      <div v-if="!hasDataFields"> <el-button class="ibps-fr ibps-pr-10" type="text" @click="addExportField">添加字段</el-button></div>
      <el-table
        max-height="500px"
      ...
      >
        ...
        <el-table-column width="180" label="管理">
          <template #default="scope">
...
export default {
  ...
  computed: {
    ...
    dataFields() {
      return this.initFormData(this.datasets)
    },
    hasDataFields() {
    ...
    data: {
      handler: function(val, oldVal) {
        ...
        if (this.$utils.isEmpty(val.export_columns)) {
          this.exportColumns.fields = this.dataFields
        } else {
  ...
  methods: {
    ...
    addExportField() {
      ...
      this.exportColumns.fields.push(field)
    },
    ...
    handleRemove(index) {
      this.exportColumns.fields.splice(index, 1)
    },
