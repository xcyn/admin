  ...
  >
    <div v-if="dialogVisible">
      <el-form v-if="verify" ref="formulaVerify" :model="form" label-width="200px" @submit.native.prevent>
        <el-form-item label="不满足校验条件时提示文字:" prop="message" required :rules=" [{ required: true, message: $t('validate.required') }]">
...
import functionData from '@/business/platform/form/formbuilder/constants/formula'
