      ...
      <div class="panel-body">
        ...
        >
          ...
          <el-form-item>
            <span slot="label">
              ...
              <el-tooltip
                ...
                placement="bottom"
              >
                <div slot="content">宽高小于100时单位为%，大于100时为px</div>
                <ibps-icon name="help" style="color:#dd5b44;" />
              </el-tooltip>
              :
            </span>
            <el-input v-model="attrs.marginTop" style="width:100%" placeholder="间距" @input="(val)=>handleAttrs('marginTop',val)" />
          </el-form-item>
          <el-form-item label="尺寸">
            ...
            <div>
              高：<el-input-number v-model="attrs.height" :min="30" placeholder="高" @input="(val)=>handleAttrs('height',val)" />
            </div>
          </el-form-item>
        </el-form>
      </div>
