        ...
        <label slot="label">{{ name }}
          ...
          <el-dropdown @command="handleScriptCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item v-if="type==='template'" command="customFormatter">自定义格式（customFormatter）</el-dropdown-item>
              ...
              <el-dropdown-item v-if="type==='template'||type==='dialog'" command="afterSubmit">按钮后置事件（afterSubmit）</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </label>
      ...
      if (this.type === 'template') {
        ...
        switch (command) {
          ...
          case 'beforeSubmit':
            ...
            break
          case 'afterSubmit':
            val = ' \n //按钮提交后置事件\n  afterSubmit:function(template, action,data,callback){\n   callback(true)  \n  }\n'
            break
          default:
            break
        }
