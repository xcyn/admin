...
export const displayDefaultValue = {
  ...
  sortable: true,
  width: '',
  combinationType: 'field',
  columnsBackGround: 'default',
  fieldColor: '#606266',
  same: 'Y',
  field_type: 'text',
  field_options: {
...
export const functionListButtonTypes = ['search', 'resetSearch', 'add', 'remove', 'logicDeleted', 'edit', 'detail', 'customDetail', 'print', 'import', 'export', 'sefStartFlow', 'custom']
