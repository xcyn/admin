    ...
    <ibps-layout ref="layout">
      ...
      <div slot="east">
        <right-aside
          ...
          @is-same-dataset-key="isSameDatasetKey"
        />
      </div>
    </ibps-layout>
  </div>
...
export default {
  ...
  watch: {
    ...
    'dataTemplate.showType': {
      handler: function(val, oldVal) {
        ...
        this.$emit('init-data-templte', this.dataTemplate)
      },
      immediate: true
    },
    'dataTemplate.type': {
  ...
  methods: {
    ...
    isSameDatasetKey(val) {
      const datasetKey = this.dataTemplate.datasetKey
      const key = val.key
      if (datasetKey !== key) {
        const showType = this.dataTemplate.showType
        if (showType === 'list') {
          this.dataTemplate.templates[0].display_columns = []
          this.dataTemplate.templates[0].export_columns = []
          this.dataTemplate.templates[0].orig_display_columns = []
          this.dataTemplate.templates[0].query_columns = []
          this.dataTemplate.templates[0].result_columns = []
          this.dataTemplate.templates[0].sort_columns = []
        } else if (showType === 'tree') {
          this.dataTemplate.templates[0].display_columns.id_key = ''
          this.dataTemplate.templates[0].display_columns.is_script = false
          this.dataTemplate.templates[0].display_columns.name_key = ''
          this.dataTemplate.templates[0].display_columns.pid_key = ''
          this.dataTemplate.templates[0].display_columns.root_label = ''
          this.dataTemplate.templates[0].display_columns.root_pid = ''
        }
      }
    },
