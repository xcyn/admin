  ...
  >
    ...
    <el-row class="manual-operation">
      ...
      <el-col v-if="active===1" :span="24" class="preview-the-data">
        <el-table ref="table" v-bind="tableData" border :height="tableHeight-tableHeight/4" style="width: 100%">
          <el-table-column>
      ...
      <el-col v-if="active===2" :span="24" class="select-fields">
        <el-table
          ...
          border
          :height="tableHeight-tableHeight/4"
          row-key="title"
...
export default {
  ...
  beforeDestroy() {
    this.fileList = null
    this.tableData = null
    this.selectFieldsTableData = null
    ...
    beforeUpload(file) {
      ...
      IbpsImport.xlsx(file)
        .then(({ header, results }) => {
          ...
          this.cacheHeight = this.tableHeight - this.tableHeight / 4
        })
      return false
    },
    // changeField(fields) {
