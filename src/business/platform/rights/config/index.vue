<template>
  ...
  >
    <div class="rights-config">
      ...
      <el-row
        v-for="(rightsType,r) in rightsTypeList"
        :key="rightsType.type"
        class="rightsType"
      >
          ...
          <tr>
            ...
            <td width="25%">
              <el-button
                ...
                @click="handleSelect(rightsType.type,rightsType)"
              >选择</el-button>
              <el-button
                v-if="!selectAll"
                type="info"
...
export default {
  ...
  methods: {
    ...
    removeRights(index, parentIndex) {
      this.rightsTypeList[parentIndex].data.splice(index, 1)
    },
    handleConfirm() {
