<template>
  <el-dialog :visible.sync="dialogVisible" :close-on-click-modal="false" :close-on-press-escape="false" class="flow-diagram-dialog" append-to-body title="流程图" top="2vh" width="80%" @open="getFormData" @close="closeDialog">
