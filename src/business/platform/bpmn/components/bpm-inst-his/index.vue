...
import Vue from 'vue'
Vue.component('BpmnFormrender', () => import('@/business/platform/bpmn/form/dialog'))
...
export default {
  ...
  methods: {
    ...
    handleDelete(index) {
      const instHisData = JSON.parse(JSON.stringify(this.instHisData))
      instHisData.splice(index, 1)
      this.instHisData = instHisData
    },
