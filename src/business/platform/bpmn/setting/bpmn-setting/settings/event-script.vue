  ...
  <div class="panel-body ibps-bpm-event-seting">
    <el-tabs v-model="activeName" @tab-click="tabClick">
      <template v-if="nodeType==='start'">
        ...
        <el-tab-pane label="初始化脚本" name="initFormScript">
          <el-row :gutter="20">
            <el-col :span="3">
              <div class="grid-content bg-purple" />说明：
            </el-col>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8" style="position:relative">
              <bpmn-form-var size="mini" :data="formVars" :props="{label: 'name'}" @callback="(data)=> handleFormVar('initFormScript',data)" />
            </el-col>
          </el-row>
          <codemirror ref="initFormScript" v-model="script.initFormScript" :options="cmOption" />
        </el-tab-pane>
      </template>
        ...
        <el-tab-pane label="前置脚本" name="start">
          <el-row :gutter="20">
            ...
            <el-col :span="21">
              ...
              <span style="color:#dd5a43">execution</span>做操作。例如设置流程变量:execution.setVariable("total", 100);<br>
              <span>保存脚本后，为了防止xss攻击所以对以下两个符号进行了转义</span>
              <pre>{{ text1 }}</pre>
              <pre>{{ text2 }}</pre>
            </el-col>
          </el-row>
  ...
  export default {
    ...
    methods: {
      tabClick(tab) {
        ...
        }else if(tab.name === 'initFormScript' && !this.initFormScriptRefresh){
          this.$refs.initFormScript.refresh()
          this.initFormScriptRefresh = true
        }
      },
