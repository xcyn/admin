  ...
  >
    ...
    >
      ...
      <el-tabs v-model="activeIndex" type="card">
            ...
            <el-row>
              <el-col :span="11">
                <el-form-item label="相对节点:" prop="relNodeId">
                  <el-select :value="relNodeId" placeholder="请选择" disabled>
              ...
              <el-col :span="11">
                <el-form-item label="相对处理事件:" prop="relNodeEvent">
                  <el-select :value="relNodeEvent" placeholder="请选择" disabled>
                    <el-option
        ...
        <!-- 发送督办消息设置 -->
        <el-tab-pane label="发送督办消息设置" name="3">
          <div>
            <el-col :span="11">
              <el-form-item label="发送督办信息:" prop="needSendMsg">
...
export default {
  ...
  beforeDestroy() {
    ...
    this.form = null
    this.rootData = null
    this.relTimeTypeOptions = null
    this.relNodeEventOptions = null
    this.actionsOptions = null
    this.rules = null
    this.toolbars = null
    this.msgTypes = null
    this.userList = null
  ...
  methods: {
    ...
    getFormData() {
      ...
      this.msgTypes = this.form.msgTypeHtml ? this.form.msgTypeHtml.split(',').concat(this.form.msgTypePt.split(',')) : []
      ...
      const startTime = this.timeStamp(this.form.startTime || 0)
      this.startTimeDays = startTime.day
      this.startTimeHours = startTime.hour
      this.startTimeMunites = startTime.min
      const interval = this.timeStamp(this.form.interval || 0)
    ...
    handleFormVar(key, node) {
      ...
      // TODO: 插入
      this.$set(this.form, key, (this.form[key] || '') + data)
    },
    handleCommonScript() {
