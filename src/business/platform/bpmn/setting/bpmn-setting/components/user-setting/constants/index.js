...
export const pluginTypes = {
  ...
  'level': {
    label: '参与者等级',
    userTypeOptions: [
      { value: 'start', label: '发起人所在{partyType}等级' },
      { value: 'prev', label: '上一步执行人所在{partyType}等级' },
      { value: 'spec', label: '指定{partyType}等级', colspan: 1 },
      // { value: 'var', label: '人员变量', colspan: 1 },
      { value: 'node', label: '相同节点执行人所在{partyType}等级', colspan: 1 }],
    defaultData: {
      source: 'start',
      partyType: 'org',
      mainPost: 'Y',
