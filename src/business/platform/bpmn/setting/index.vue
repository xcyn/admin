<template>
  ...
  >
    <div slot="title" style="padding-left: 10px;">
      ...
      <el-button v-if="$utils.isNotEmpty(parentDefKey)" v-permission="BPMN_BPMN_DEF_SETTING+'_confirm'" type="primary" icon="ibps-icon-ok" @click="handleConfirm()">确定</el-button>
      <el-button v-else v-permission="BPMN_BPMN_DEF_SETTING+'_save'" type="primary" icon="ibps-icon-save" @click="handleSave()">保存</el-button>
    ...
    >
      ...
      >
        ...
        <el-button v-permission="BPMN_BPMN_DEF_SETTING+'_bpmnxml'" type="primary" plain icon="ibps-icon-file-code-o" size="mini" @click="onXmlClick('bpmn')">BPMNXML</el-button>
        <el-button v-permission="BPMN_BPMN_DEF_SETTING+'_designxml'" type="primary" plain icon="ibps-icon-file-code-o" size="mini" @click="onXmlClick('design')">DesignXML</el-button>
      </el-alert>
      <bpmn-image
        ref="bpmnImage"
...
export default {
  ...
  data() {
    return {
      BPMN_BPMN_DEF_SETTING: Identity.IBPS.BPMN.BPMN_BPMN_DEF_SETTING,
