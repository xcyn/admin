...
<script>
import { defaultOptions, jsonDataTypeOptions, typeOptions, bindRequestTypeOptions, bindResponseTypeOptions, ibpsResponseOptions, ibpsRequestOptions, items } from '../constants'
...
export default {
  ...
  beforeDestroy() {
    ...
    this.ibpsResponseOptions = null
    this.ibpsRequestOptions = null
  },
  methods: {
