...
export function getTable(param) {
  return businessRequest({
    method: 'get',
    url: EXAMINATION_URL() + `/api/examAnswer/examingList`,
    params: param
  })
}
...
export function getExamTopic(param) {
  return businessRequest({
    method: 'get',
    url: EXAMINATION_URL() + `/api/examAnswer/queryExamTopicByExamId`,
    params: param
  })
}
...
export function submitPaper(param) {
  return businessRequest({
    method: 'post',
    url: EXAMINATION_URL() + `/api/examAnswer/submitPaper`,
    data: param
  })
}
...
export function getBeginExam(param, param2) {
  return businessRequest({
    method: 'get',
    url: EXAMINATION_URL() + `/api/exam/beginExam?id=${param}&userId=${param2}`
  })
}
...
// 导出
export function exportExl(param) {
  return businessRequest({
    method: 'get',
    responseType: 'blob',
    url: EXAMINATION_URL() + `/api/examAnswer/examingExportXls`,
    params: param
  })
}
